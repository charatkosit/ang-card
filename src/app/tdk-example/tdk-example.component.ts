...
@Component({
  selector: 'app-tdk-example',
  templateUrl: './tdk-example.component.html',
  styleUrls: ['./tdk-example.component.css']
})
export class TdkExampleComponent implements OnInit, OnDestroy {
  ...
  @ViewChild('readerSelected') readerSelected!: ElementRef;
  @ViewChild('physicalAddress') physicalAddress!: ElementRef;
  @ViewChild('firstNameT') firstNameT!: ElementRef;
  @ViewChild('middleNameT') middleNameT!: ElementRef;
  @ViewChild('lastNameT') lastNameT!: ElementRef;
  @ViewChild('firstNameE') firstNameE!: ElementRef;
  @ViewChild('middleNameE') middleNameE!: ElementRef;
  ...
  @ViewChild('issueNum') issueNum!: ElementRef;
  @ViewChild('placeOfIssue') placeOfIssue!: ElementRef;
  @ViewChild('bp1RequestNumber') bp1RequestNumber!: ElementRef;
  @ViewChild('issuerCode') issuerCode!: ElementRef;
  @ViewChild('structureVersion') structureVersion!: ElementRef;
  @ViewChild('cardType') cardType!: ElementRef;
  @ViewChild('titleFlag') titleFlag!: ElementRef;
  ...
  putToScreen(jsObj: any) {
    ...
    if (status == 0) {
      ...
      if (IDText != "") {
        ...
        this.issueNum.nativeElement.value = NIDData[22];
        this.nidNum.nativeElement.value = NIDData[0];
        this.firstNameT.nativeElement.value = NIDData[1] + " " + NIDData[2];
        this.middleNameT.nativeElement.value = NIDData[3];
        this.lastNameT.nativeElement.value = NIDData[4];
        this.firstNameE.nativeElement.value = NIDData[5] + " " + NIDData[6];
        this.middleNameE.nativeElement.value = NIDData[7];
        this.lastNameE.nativeElement.value = NIDData[8];
        ...
        this.issueDate.nativeElement.value = this.add_slash(NIDData[20]);
        this.expireDate.nativeElement.value = this.add_slash(NIDData[21]);
        this.placeOfIssue.nativeElement.value = NIDData[19];
      }
      ...
      if (IDAText != "") {
        ...
        if (NIDData.length > 23) {
          this.bp1RequestNumber.nativeElement.value = NIDData[23];
          this.issuerCode.nativeElement.value = NIDData[24];
          this.structureVersion.nativeElement.value = NIDData[25];
          this.cardType.nativeElement.value = NIDData[26];
  ...
  clearScreen() {
    ...
    this.middleNameT.nativeElement.value = "";
    this.lastNameT.nativeElement.value = "";
    this.firstNameE.nativeElement.value = "";
    this.middleNameE.nativeElement.value = "";
    this.lastNameE.nativeElement.value = "";
    this.birthDate.nativeElement.value = "";
    this.gender.nativeElement.value = "";
    this.address.nativeElement.value = "";
    this.issueDate.nativeElement.value = "";
    this.expireDate.nativeElement.value = "";
    this.issueNum.nativeElement.value = "";
    this.placeOfIssue.nativeElement.value = "";
    this.bp1RequestNumber.nativeElement.value = "";
    this.issuerCode.nativeElement.value = "";
    this.structureVersion.nativeElement.value = "";
    this.cardType.nativeElement.value = "";
    this.titleFlag.nativeElement.value = "";
    this.photo.nativeElement.src = "assets/images/PNIDCard.JPG";
